...
# Model Save Path
MODEL_NAME = "resnet101_optimized.h5"
...
def create_resnet101_model():
    """ResNet101V2 with fine-tuning and improved regularization."""
...
def train_resnet101():
    if os.path.exists(f"models/{MODEL_NAME}"):
        print(f"Loading existing ResNet101 model from {MODEL_NAME}")
        model = load_model(f"models/{MODEL_NAME}")
    else:
        print("Training new ResNet101 model...")
